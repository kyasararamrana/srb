...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <?php } ?>
            <?php if ($this->session->userdata('role') == 'Superadmin' || $this->session->userdata('role') == 'Order') { ?>
              <!--- Another Role --->
            ...
            <?php } ?>
            <?php if ($this->session->userdata('role') == 'Sales' || $this->session->userdata('role') == 'Superadmin') { ?>
              <!--- Another Role --->
