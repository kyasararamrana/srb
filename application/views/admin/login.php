...
<body class="hold-transition login-page" style="background:url(<?php echo base_url('assets/img/admin/bg1.jpg'); ?>);background-size:cover;">
    <div class="" style="height: 100%; background-color: rgba(0, 0, 0, 0.25);">
        <div class="login-box">
