                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-success">
                            <!-- form start -->
                            <form id="roleForm" name="roleForm" method="post" action="<?php if (isset($user->id)) { echo base_url('inventory/update'); } else { echo base_url('inventory/create'); } ?>" enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="role">
                                              ...
                                              <option value="Zip" <?php echo (isset($user->role) && ($user->role == "Zip")) ? 'selected' : '' ; ?>>Zip</option>
                                              <option value="Handle" <?php echo (isset($user->role) && ($user->role == "Handle")) ? 'selected' : '' ; ?>>Handle</option>
                                              <option value="Sidepatty" <?php echo (isset($user->role) && ($user->role == "Sidepatty")) ? 'selected' : '' ; ?>>Sidepatty</option>
                                              <option value="Bag" <?php echo (isset($user->role) && ($user->role == "Bag")) ? 'selected' : '' ; ?>>Bag</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
            ...
            name: {
              ...
              email: {
                validators: {
                  ...
                  remote: {
                    type: 'POST',
                    url: '<?php echo base_url('inventory/check_exists'); ?>',
