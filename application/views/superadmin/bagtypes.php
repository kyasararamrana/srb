                      ...
                      <?php if (count($bagtypes) > 0) { ?>
                        ...
                        <?php foreach($bagtypes as $bagtype) { ?>
                          <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url('bagtype/edit/'.$bagtype->id); ?>" type="button" class="btn btn-info mr-10"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url('bagtype/delete/'.$bagtype->id); ?>" type="button" class="btn btn-danger mr-10 confirmation"><i class="fa fa-trash-o"></i></a>
                          </td>
                        </tr>
                        <?php $sno++; ?>
                      <?php } ?>
