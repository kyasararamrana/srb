                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-success">
                            <!-- form start -->
                            <form id="" name="" action="<?php echo base_url('material/insert'); ?>" method="post">
                                <div class="box-body">
                                    <div class="col-md-12">
										<div class="table-responsive">
                                            <table id="myTable" class="table table-list">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="col-md-6">
                                                            <input type="text" name="material[]" placeholder="Enter Material" class="form-control" required>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addRow").on("click", function() {
                var newRow = $("<tr>");
                var cols = "";
                cols += '<td><input type="text" class="form-control" placeholder="Enter Material" name="material[]" required></td>';
