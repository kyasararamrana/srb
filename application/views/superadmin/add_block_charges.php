                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-success">
                            <!-- form start -->
                            <form id="" name="" action="<?php echo base_url('block/insert'); ?>" method="post">
                                <div class="box-body">
                                    <div class="col-md-12">
									 <div class="row">
                                          <div class="col-md-6">
                                        ...
                                        <div class="table-responsive">
                                            <table id="myTable" class="table table-list">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="col-md-6">
                                                            <input type="text" name="block_type[]" placeholder="Block Type" class="form-control" required>
                                                        </td>
														<td class="col-md-6">
                                                            <input type="text" name="block_amt[]" placeholder="Block Amount" class="form-control" required>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addRow").on("click", function() {
                var newRow = $("<tr>");
                var cols = "";
                cols += '<td><input type="text" class="form-control" placeholder="Block Type" name="block_type[]"/></td>';
                cols += '<td><input type="text" name="block_amt[]" placeholder="Block Amount" class="form-control" /></td>';
