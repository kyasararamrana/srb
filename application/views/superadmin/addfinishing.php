        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add Finishing Size</li>
                </ol>
            </section>
            <!-- Main content -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-success">
                            <!-- form start -->
                            <form id="" name="" action="<?php echo base_url('finishing/insert'); ?>" method="post">
                                <div class="box-body">
								<div class="col-md-6">
										...
										<div class="table-responsive">
                                            <table id="myTable" class="table table-list">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="col-md-6">
                                                            <input type="text" name="finishing_size[]" placeholder="Enter Finishing Size" class="form-control" required>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addRow").on("click", function() {
                var newRow = $("<tr>");
                var cols = "";
                cols += '<td><input type="text" class="form-control" placeholder="Enter Finishing Size" name="finishing_size[]" required></td>';
