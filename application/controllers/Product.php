  ...
  public function insert()
  {
    if ($this->session->userdata('logged_in') == TRUE) {
      ...
      if ($post_data) {
        ...
        $addl_data = array('image' => $image,'thumbnail1' => $thumbnail1, 'thumbnail2' => $thumbnail2, 'thumbnail3' => $thumbnail3, 'featured' => (int)$this->input->post('featured'),'created_on' => date('Y-m-d H:i:s'),'created_by' => $this->session->userdata('id'), 'status' => '1' );
  ...
  public function update()
  {
    if ($this->session->userdata('logged_in') == TRUE) {
      ...
      if ($post_data) {
          ...
          $addl_data = array('image' => $image, 'thumbnail1' => $thumbnail1, 'thumbnail2' => $thumbnail2, 'thumbnail3' => $thumbnail3, 'featured' => (int)$this->input->post('featured'),'updated_by' => $this->session->userdata('id'), 'updated_on' => date('Y-m-d H:i:s'));
          $post_data = array_merge($post_data,$addl_data);
